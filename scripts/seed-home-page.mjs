...
// discard those edits.
//
// NOTE: this script's content is the ORIGINAL bootstrap copy (includes
// Anton and YASIROV Films mentions) - only useful for a brand-new, empty
// dataset. For the current site, use scripts/migrate-and-seed.mjs instead,
// which updates the existing document without wiping your edits.
